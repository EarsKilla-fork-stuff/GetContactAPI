...
namespace GetContactAPI
{
    public class API
    {
        ...
        /// </summary>
        public ApiResponse<SearchResult> GetByPhone(string phone, string countryCode = null, string source = null)
        {
        ...
        /// </summary>
        public ApiResponse<DetailsResult> GetTags(string phone, string countryCode = null, string source = null)
        {
            if (String.IsNullOrEmpty(phone) || !Regex.IsMatch(phone, "\\+?\\d{11}")) throw new ArgumentException("Телефон заполнен неправильно");
